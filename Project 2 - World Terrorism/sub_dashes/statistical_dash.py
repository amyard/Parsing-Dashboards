...
def Statictic():
    ...
    fig_plots = html.Div(style={'height':'1000', 'background':'black', 'width':'1600px'}, children = [
        # title
        html.H1(children = 'Statictical information', style={'textAlign':'center', 'color':'white', 'padding-top':'20'}),
